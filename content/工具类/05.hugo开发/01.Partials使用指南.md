...
type: docs
description: >-
  本文详细介绍了Hugo项目中Partials的使用方法，包括定义、基本语法、动态路径引用、条件调用、参数传递以及缓存策略。通过示例代码展示了如何创建和引用模板片段，如何结合Scratch进行路径管理，以及如何使用partialCached提升构建性能。整体内容帮助开发者更高效地复用模板代码，优化项目结构，适应多语言和复杂需求。
weight: 500
tags:
  - hugo
categories:
