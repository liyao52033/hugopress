...
url: /pages/9b14d2
type: docs
description: vue-element-admin 后台管理框架使用指南，包括移除 mock、配置代理等
cover: https://cnb.xiaoying.org.cn?random=/pages/162f13
weight: 200
license: true
twikoo: true
footer: false
...
### vue.config.js删除before: require('./mock/mock-server.js')
...
### 修改 /store/modules/user的请求,将请求字段跟后端一致
