...
twikoo: true
footer: false
description: "本文介绍了TortoiseGit的SSH配置方法。由于TortoiseGit使用ppk格式密钥而非OpenSSH格式，需通过PuTTY Key Generator生成密钥，保存为private.ppk文件。随后使用Pageant工具加载该密钥，并在Git和TortoiseGit设置中分别添加SSH Key及指定private.ppk路径。完成配置后即可使用TortoiseGit进行代码拉取与提交操作。"
---
