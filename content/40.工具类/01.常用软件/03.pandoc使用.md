...
description: "本文介绍了文档转换工具Pandoc的常规选项和常用命令。主要内容包括如何指定输入和输出格式，列举了支持的多种格式如Markdown、HTML、LaTeX、DOCX等，并说明了通过扩展名启用或禁用特定功能。文章还概述了常用命令，例如生成独立HTML文件、转换为PDF、处理幻灯片和电子书等操作，展示了Pandoc在格式转换和文档处理方面的灵活性与强大功能。"
url: /pages/e3350e
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/9142cd
weight: 300
---
