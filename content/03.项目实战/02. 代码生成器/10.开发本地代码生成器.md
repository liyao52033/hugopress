...
url: /pages/fb1d31
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/77d583
weight: 10
description: "本文介绍了开发本地代码生成器的完整流程。首先进行项目初始化，包括创建根目录、使用Git管理以及配置.gitignore文件。接着讲解静态文件生成的两种方法：使用Hutool工具快速复制或通过递归遍历实现灵活复制。然后详细说明动态文件代码生成的四个核心步骤：定义数据模型、编写动态模板、组合生成以及完善优化。最后通过动静结合的方式，先复制静态文件再动态生成文件，从而完成完整代码的生成。"
---
...
![image.png](https://img.xiaoying.org.cn/img/202312031428964.png)
...
![image.png](https://img.xiaoying.org.cn/img/202312031428856.png)
...
![image.png](https://img.xiaoying.org.cn/img/202312031428762.png)

然后在项目根目录处选中右键，使用 .ignore 插件创建 .gitignore 文件：

![image.png](https://img.xiaoying.org.cn/img/202312031428829.png)

.ignore 插件提供了很多默认的 .gitignore 模板，根据自己的项目类型和使用的开发工具进行选择，此处我们选择 Java 和 JetBrains 模板：

![image.png](https://img.xiaoying.org.cn/img/202312031428902.png)

然后可以在项目根目录看到生成的 .gitignore 文件，模板已经包含了常用的 Java 项目忽略清单，比如编译后的文件、日志文件、压缩包等：

![image.png](https://img.xiaoying.org.cn/img/202312031428803.png)

让我们再手动添加几个要忽略的目录和文件，比如打包生成的 target 目录：

![image.png](https://img.xiaoying.org.cn/img/202312031428464.png)

但是，我们会发现，即使有些文件已经添加到了 .gitignore 文件中，在 IDEA 中显示的还是绿色（已被 Git 托管）状态。如下图：

![image.png](https://img.xiaoying.org.cn/img/202312031428927.png)
...
![image.png](https://img.xiaoying.org.cn/img/202312031428702.png)

可以看到文件变成了红色（未被 Git 托管）或黄色（被忽略）状态：

![image.png](https://img.xiaoying.org.cn/img/202312031428759.png)

然后，让我们将 .gitignore 文件添加到 Git 暂存区，让它能够被 Git 管理。

![image.png](https://img.xiaoying.org.cn/img/202312031428272.png)
...
![image.png](https://img.xiaoying.org.cn/img/202312071710146.png)
...
![image.png](https://img.xiaoying.org.cn/img/202312071731509.png)
