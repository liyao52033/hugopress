---
date: 2025-09-06T16:44:03.000Z
title: 配置meilisearch
author:
  name: 华总
  link: https://xiaoying.org.cn
url: /pages/09b133
description: "本文介绍了如何配置Meilisearch搜索引擎。主要内容包括服务端部署（使用Docker）、创建master key和search key、配置域名和建立索引。同时，文章也说明了如何在代码中配置Meilisearch组件，并利用GitHub Action实现索引自动化更新，确保新发布文章能及时被搜索到。"
weight: 90
categories:
  - 工具类
  - 本站插件
...
tags:
  - vitepress
cover: https://cnb.xiaoying.org.cn?random=/pages/79b80b
---
