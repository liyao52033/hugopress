...
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/a9b41e
description: "本文介绍了基于现有组件库开发新组件的完整流程。主要步骤包括：在指定目录创建新组件并在入口文件注册；在类型声明文件的四个位置添加相应的类型定义；最后更新版本号并完成发布。"
---
