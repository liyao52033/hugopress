...
url: /pages/bfdaa2
type: docs
description: Spring MVC HTTP 参数接收方式，介绍 PathVariable、Query、RequestBody 等
cover: https://cnb.xiaoying.org.cn?random=/pages/ac5de2
weight: 109
license: true
twikoo: true
footer: false
...
## application/x-www-form-urlencoded 传参

### `@RequestParam` 和 `@ModelAttribute`
