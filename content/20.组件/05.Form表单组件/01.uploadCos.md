...
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/b2bfee
description: "本文介绍了一个拖拽式文件上传组件“uploadCos”，其主要功能是将图片等文件上传至对象存储服务（如COS、OSS）。文章概述了该组件的核心参数配置、可用的插槽（包括默认拖拽区域和提示信息区域），并简要提及了基本使用、带参数使用以及通过插槽自定义内容等几种使用示例。"
---
