...
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/71817c
description: "本文介绍了一个基于el-table封装的表单组件。该组件可通过参数isPopover进行模式切换：当isPopover为false时，它表现为一个表单；当isPopover为true时，则变为一个Select选择器，其选择的内容将作为表单内容。文章还提供了相关的使用示例文件。"
---
