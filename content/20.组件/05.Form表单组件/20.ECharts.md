...
type: docs
cover: https://cnb.xiaoying.org.cn?random=/pages/c04f81
description: "本文介绍了ECharts图表库的基本使用方法，强调其已封装好，无需单独引入。文章核心是列举并简要说明了构建ECharts图表的核心配置项，包括提示框、图例、坐标轴、数据系列、网格、颜色、标题、工具栏、动画、背景色、响应式及极坐标系等。最后指出不同图表类型有更具体的选项，并指引用户参考官方文档。"
---
