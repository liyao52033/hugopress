...
url: /pages/fb0a8c
type: docs
description: Apache Commons StringUtils 工具类使用，包含字符串截取、判断等常用方法
cover: https://cnb.xiaoying.org.cn?random=/pages/61cb29
weight: 108
license: true
twikoo: true
footer: false
...
![](https://img.xiaoying.org.cn/img/202310032244257.png)

## 静态常量

StringUtils 提供了最常用的常量如下，使用定义的常量能让我们的代码更清晰。

![1532358237](https://img.xiaoying.org.cn/img/202310032248030.jpg)
