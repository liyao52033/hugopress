...
url: /pages/3aabf1
type: docs
description: Docker Compose 使用指南，包含安装、配置和 Dockerfile 编写
cover: https://cnb.xiaoying.org.cn?random=/pages/a0ca8d
weight: 135
license: true
twikoo: true
footer: false
...
### [创建 Dockerfile](https://docs.docker.com/compose/gettingstarted/#step-2-create-a-dockerfile)
